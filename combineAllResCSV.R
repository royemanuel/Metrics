setwd("d:/OneDrive/PhD Work/Dissertation/Programming/Metrics/5JULres/")
...
write_csv(allRes2, "d:/OneDrive/PhD Work/Dissertation/Word/Journal Articles/Fleet Resilience/allRes.csv")
