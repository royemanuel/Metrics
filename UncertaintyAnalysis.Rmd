...
```{r Time_to_failure_experiment, echo=FALSE, message=FALSE, error=FALSE}
...
```{R Changing_need_and_fail_levels, echo=FALSE, message=FALSE, error=FALSE}
